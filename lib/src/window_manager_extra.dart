...
import 'package:window_manager_extra/src/title_bar_style.dart';
import 'package:window_manager_extra/src/utils/calc_window_position.dart';
import 'package:window_manager_extra/src/window_listener.dart';
import 'package:window_manager_extra/src/window_options.dart';
...
class WindowManagerExtra {
  ...
  Future<void> setBackgroundColor(Color backgroundColor) async {
    final Map<String, dynamic> arguments = {
      'backgroundColorA': (backgroundColor.alpha * 255).round() & 0xff,
      'backgroundColorR': (backgroundColor.red * 255).round() & 0xff,
      'backgroundColorG': (backgroundColor.green * 255).round() & 0xff,
      'backgroundColorB': (backgroundColor.blue * 255).round() & 0xff,
    };
